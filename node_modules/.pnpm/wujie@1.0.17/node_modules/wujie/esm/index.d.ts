...
declare type eventListenerHook = (iframeWindow: Window, type: string, handler: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions) => void;
export declare type loadErrorHandler = (url: string, e: Error) => any;
...
declare type optionProperty = "url" | "el";
/**
 * 合并 preOptions 和 startOptions，并且将 url 和 el 变成可选
 */
export declare type cacheOptions = Omit<preOptions & startOptions, optionProperty> & Partial<Pick<startOptions, optionProperty>>;
/**
 * 缓存子应用配置
 */
